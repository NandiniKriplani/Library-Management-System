...
GO
	...
	CREATE TABLE dbl_library_branch_info (
		library_branch_BranchID INT PRIMARY KEY NOT NULL IDENTITY (1,1),
		library_branch_BranchName VARCHAR(100) NOT NULL,
		library_branch_BranchAddress VARCHAR(200) NOT NULL,
	);

	SELECT * FROM dbl_library_branch_info

	CREATE TABLE dbl_borrower_info (
	...
	SELECT * FROM dbl_borrower_info

	CREATE TABLE dbl_book_loans_info (
	...
	SELECT * FROM dbl_book_copies_info

	CREATE TABLE dbl_book_authors _info(
	...
	SELECT * FROM dbl_book_authors_info
...
/*==================== POPULATING TABLES ======================*/
	...
	INSERT INTO dbl_publisher_info
		...
		('Jayant Gautam','Oga Bldg. 8, 2-5-4 Sarugaku-cho, Chiyoda-ku, Tokyo 101-0064 Japan','+81-3-5577-6507'),
	...
	SELECT * FROM dbl_publisher_info

	INSERT INTO dbl_book_info
	...
	SELECT * FROM tbl_book_info WHERE book_PublisherName = 'George Allen & Unwin'

	INSERT INTO tbl_library_branch_info
	...
	SELECT * FROM tbl_library_branch_info

	INSERT INTO tbl_borrower_info
	...
	SELECT * FROM tbl_borrower_info

	INSERT INTO tbl_book_loans_info
	...
	SELECT * FROM tbl_book_loans_info

	INSERT INTO tbl_book_copies_info
	...
	SELECT * FROM tbl_book_copies_info
 

	INSERT INTO tbl_book_authors_info
	...
	SELECT * FROM tbl_book_authors_info
END
...
/* #7- For each book authored by "Jayant Gautam", retrieve the title and the number of copies owned by the library branch whose name is "Central".*/

CREATE PROC dbo.BookbyAuthorandBranch
	(@BranchName varchar(50) = 'Central', @AuthorName varchar(50) = 'Jayant Gautam')
AS
